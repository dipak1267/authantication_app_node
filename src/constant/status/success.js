const success = {
    ...
    Non_Authoritative_Information: {
        code: 203,
        message: 'The server is a transforming proxy  that received a 200 OK from its origin, but is returning a modified version of the origin response .'
    },
    No_Content: {
        code: 204,
    ...
    Reset_Content: {
        code: 205,
        message: 'The server successfully processed the request, asks that the requester reset its document view, and is not returning any content. '
    },
    Partial_Content: {
        code: 206,
